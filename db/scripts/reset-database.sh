...
# Database reset script for Student Service
# This script resets the PostgreSQL database by dropping and recreating it
...
# Function to reset database using Docker Compose
reset_container() {
    print_status "INFO" "Stopping and removing PostgreSQL container using Docker Compose..."
    ...
    print_status "SUCCESS" "PostgreSQL container and data removed"
}

# Function to start fresh container using Docker Compose
start_fresh_postgres() {
    print_status "INFO" "Starting fresh PostgreSQL container using Docker Compose..."
...
display_connection_info() {
    print_status "INFO" "Database reset completed successfully!"
    echo
...
# Main execution
main() {
    print_status "INFO" "Starting database reset for Student Service..."
    ...
    execute_sql "$(dirname "$0")/../sql/01_create_database.sql" "Database and user creation"
